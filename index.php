...
<body>
    <main>
        <div class="container destaque">
                ...
                <nav>
                    <ul>
                        <li><a href="#">Blusas e Camisas</a>
                            <ul>
                                <a href="#"><li>Manga curta</li></a>
                                <a href="#"><li>Manga comprida</li></a>
                                <a href="#"><li>Camisa social</li></a>
                                <a href="#"><li>Camisa casual</li></a>
                            </ul>
                        </li>
            ...
            <img src="img/destaque-home.png" alt="Promoção: Big City Night" class="promocao">
        </div>
